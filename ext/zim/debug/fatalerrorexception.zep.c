...
PHP_METHOD(Zim_Debug_FatalErrorException, setTrace) {
	...
	ZEPHIR_CALL_METHOD(NULL, &traceReflector, "__construct", NULL, 37, &_0, &_1);
	zephir_check_call_status();
	ZVAL_BOOL(&_2, 1);
	ZEPHIR_CALL_METHOD(NULL, &traceReflector, "setaccessible", NULL, 55, &_2);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, &traceReflector, "setvalue", NULL, 56, this_ptr, trace);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
