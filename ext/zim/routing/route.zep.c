...
PHP_METHOD(Zim_Routing_Route, setPath) {
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "?<");
	ZEPHIR_CALL_FUNCTION(&_1, "strpbrk", NULL, 105, &pattern, &_0);
	zephir_check_call_status();
...
PHP_METHOD(Zim_Routing_Route, setPathCallback) {
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *m, m_sub, _0, _6, _12, _1$$3, _2$$3, _3$$3, _4$$3, _5$$3, _7$$4, _8$$4, _9$$4, _10$$4, _11$$4;
	zval *this_ptr = getThis();
...
PHP_METHOD(Zim_Routing_Route, setMethods) {
	...
	ZEPHIR_CALL_FUNCTION(&_2, "array_map", NULL, 78, &_1, &_0);
	zephir_check_call_status();
...
PHP_METHOD(Zim_Routing_Route, sanitizeRequirement) {
	...
	if (ZEPHIR_IS_STRING_IDENTICAL(regex, "")) {
		...
		ZEPHIR_CALL_FUNCTION(&_16$$6, "sprintf", &_3, 22, &_15$$6, key);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, &_14$$6, "__construct", NULL, 28, &_16$$6);
		zephir_check_call_status();
...
PHP_METHOD(Zim_Routing_Route, __callStatic) {
	...
	if (!(zephir_is_true(&_0))) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 106, &_2$$3);
		zephir_check_call_status();
