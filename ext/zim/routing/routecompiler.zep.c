...
PHP_METHOD(Zim_Routing_RouteCompiler, compile) {
	...
	ZEPHIR_CALL_FUNCTION(&_4, "array_unique", NULL, 114, &variables);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 115, &_1, &_2, &_3, &pathVariables, &_4);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Zim_Routing_RouteCompiler, compilePattern) {
	...
	if (_5) {
		...
		ZEPHIR_CALL_FUNCTION(&_12$$3, "sprintf", &_13, 17, &_11$$3, &_10$$3);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, &_9$$3, "__construct", NULL, 4, &_12$$3);
		zephir_check_call_status();
	...
	if (_14) {
		...
		ZEPHIR_CALL_FUNCTION(&_17$$4, "sprintf", &_13, 17, &_16$$4, pattern);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, &_15$$4, "__construct", NULL, 4, &_17$$4);
		zephir_check_call_status();
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&matches), _23)
	{
		...
		if (zephir_is_true(&_45$$5)) {
			...
			ZEPHIR_CALL_FUNCTION(&_49$$9, "sprintf", &_13, 17, &_48$$9, &varName, pattern);
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(NULL, &_47$$9, "__construct", &_50, 116, &_49$$9);
			zephir_check_call_status();
		...
		if (zephir_fast_in_array(&varName, &variables TSRMLS_CC)) {
			...
			ZEPHIR_CALL_FUNCTION(&_53$$10, "sprintf", &_13, 17, &_52$$10, pattern, &varName);
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(NULL, &_51$$10, "__construct", NULL, 4, &_53$$10);
			zephir_check_call_status();
		...
		if (zephir_fast_strlen_ev(&varName) > 32) {
			...
			ZVAL_LONG(&_56$$11, 32);
			ZEPHIR_CALL_FUNCTION(&_57$$11, "sprintf", &_13, 17, &_55$$11, &varName, &_56$$11, pattern);
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(NULL, &_54$$11, "__construct", &_50, 116, &_57$$11);
			zephir_check_call_status();
		...
		if (Z_TYPE_P(&regexp) == IS_NULL) {
			...
			ZVAL_STRING(&_70$$14, "#");
			ZEPHIR_CALL_FUNCTION(&_71$$14, "preg_quote", &_72, 77, &defaultSeparator, &_70$$14);
			zephir_check_call_status();
			...
			if (_74$$14) {
				ZEPHIR_INIT_NVAR(&_70$$14);
				ZVAL_STRING(&_70$$14, "#");
				ZEPHIR_CALL_FUNCTION(&_73$$14, "preg_quote", &_72, 77, &nextSeparator, &_70$$14);
				zephir_check_call_status();
			} else {
			...
			ZEPHIR_CALL_FUNCTION(&regexp, "sprintf", &_13, 17, &_70$$14, &_71$$14, &_73$$14);
			zephir_check_call_status();
			...
			if (!(zephir_is_true(&_82$$16))) {
				...
				ZEPHIR_CALL_FUNCTION(&_91$$18, "sprintf", &_13, 17, &_90$$18, &varName, pattern);
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(NULL, &_89$$18, "__construct", NULL, 4, &_91$$18);
				zephir_check_call_status();
			...
			if (_92$$16) {
				...
				ZEPHIR_CALL_FUNCTION(&_95$$19, "sprintf", &_13, 17, &_94$$19, &varName, pattern);
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(NULL, &_93$$19, "__construct", NULL, 4, &_95$$19);
				zephir_check_call_status();
	...
	ZVAL_LONG(&_104, 0);
	ZEPHIR_CALL_FUNCTION(&aa, "range", &_105, 117, &_103, &_104);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_123, "array_reverse", NULL, 106, &tokens);
	zephir_check_call_status();
...
PHP_METHOD(Zim_Routing_RouteCompiler, findNextSeparator) {
	...
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "");
	ZEPHIR_CALL_FUNCTION(&_2, "preg_replace", NULL, 23, &_0, &_1, &pattern);
	zephir_check_call_status();
...
PHP_METHOD(Zim_Routing_RouteCompiler, computeRegexp) {
	...
	if (ZEPHIR_IS_STRING_IDENTICAL(&_0, "text")) {
		...
		ZEPHIR_INIT_VAR(&_2$$3);
		ZVAL_STRING(&_2$$3, "#");
		ZEPHIR_RETURN_CALL_FUNCTION("preg_quote", &_3, 77, &_1$$3, &_2$$3);
		zephir_check_call_status();
		RETURN_MM();
	} else {
		_4$$4 = 0 == index;
		...
		if (_4$$4) {
			...
			ZEPHIR_INIT_VAR(&_6$$5);
			ZVAL_STRING(&_6$$5, "#");
			ZEPHIR_CALL_FUNCTION(&_7$$5, "preg_quote", &_3, 77, &_5$$5, &_6$$5);
			zephir_check_call_status();
			...
			ZEPHIR_RETURN_CALL_FUNCTION("sprintf", &_10, 17, &_6$$5, &_7$$5, &_8$$5, &_9$$5);
			zephir_check_call_status();
			RETURN_MM();
		} else {
			...
			ZVAL_STRING(&_12$$6, "#");
			ZEPHIR_CALL_FUNCTION(&_13$$6, "preg_quote", &_3, 77, &_11$$6, &_12$$6);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_FUNCTION(&regexp, "sprintf", &_10, 17, &_12$$6, &_13$$6, &_14$$6, &_15$$6);
			zephir_check_call_status();
			if (index >= firstOptional) {
				...
				if ((zephir_get_numberval(&nbTokens) - 1) == index) {
					...
					ZEPHIR_CALL_FUNCTION(&_20$$8, "str_repeat", NULL, 118, &_18$$8, &_19$$8);
					zephir_check_call_status();
...
PHP_METHOD(Zim_Routing_RouteCompiler, transformCapturingGroupsToNonCapturings) {
	...
	while (1) {
		...
		ZVAL_LONG(&_2$$3, i);
		ZVAL_LONG(&_10$$3, 0);
		ZEPHIR_CALL_FUNCTION(&_11$$3, "substr_replace", &_12, 52, &regexp, &_9$$3, &_2$$3, &_10$$3);
		zephir_check_call_status();
