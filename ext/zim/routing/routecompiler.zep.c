...
PHP_METHOD(Zim_Routing_RouteCompiler, compile) {
	...
	ZEPHIR_CALL_FUNCTION(&_4, "array_unique", NULL, 118, &variables);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 119, &_1, &_2, &_3, &pathVariables, &_4);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Zim_Routing_RouteCompiler, compilePattern) {
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&matches), _23)
	{
		...
		if (zephir_is_true(&_45$$5)) {
			...
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(NULL, &_47$$9, "__construct", &_50, 120, &_49$$9);
			zephir_check_call_status();
		...
		if (zephir_fast_strlen_ev(&varName) > 32) {
			...
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(NULL, &_54$$11, "__construct", &_50, 120, &_57$$11);
			zephir_check_call_status();
		...
		if (Z_TYPE_P(&regexp) == IS_NULL) {
			...
			ZVAL_STRING(&_70$$14, "#");
			ZEPHIR_CALL_FUNCTION(&_71$$14, "preg_quote", &_72, 79, &defaultSeparator, &_70$$14);
			zephir_check_call_status();
			...
			if (_74$$14) {
				ZEPHIR_INIT_NVAR(&_70$$14);
				ZVAL_STRING(&_70$$14, "#");
				ZEPHIR_CALL_FUNCTION(&_73$$14, "preg_quote", &_72, 79, &nextSeparator, &_70$$14);
				zephir_check_call_status();
			} else {
	...
	ZVAL_LONG(&_104, 0);
	ZEPHIR_CALL_FUNCTION(&aa, "range", &_105, 121, &_103, &_104);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_123, "array_reverse", NULL, 110, &tokens);
	zephir_check_call_status();
		...
		if (_4$$4) {
			...
			if (index >= firstOptional) {
				...
				if ((zephir_get_numberval(&nbTokens) - 1) == index) {
					...
					ZEPHIR_CALL_FUNCTION(&_20$$8, "str_repeat", NULL, 122, &_18$$8, &_19$$8);
					zephir_check_call_status();
