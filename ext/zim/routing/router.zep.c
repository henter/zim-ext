...
PHP_METHOD(Zim_Routing_Router, addRoute) {
	...
	if (_0) {
		...
		ZEPHIR_CALL_FUNCTION(&name, "sha1", NULL, 123, &_2$$4);
		zephir_check_call_status();
	}
...
PHP_METHOD(Zim_Routing_Router, createRoute) {
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 124, &uri, &defaults, &requirements, methods, &options);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Zim_Routing_Router, match) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "rawurldecode", NULL, 112, &path);
	zephir_check_call_status();
	...
	if (_2) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_4$$4, "__construct", NULL, 94);
		zephir_check_call_status();
	...
	if (0 < zephir_fast_count_int(&_6 TSRMLS_CC)) {
		...
		ZEPHIR_CALL_FUNCTION(&_8, "array_unique", NULL, 118, &_7);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, &_5, "__construct", NULL, 125, &_8);
		zephir_check_call_status();
	} else {
		ZEPHIR_INIT_NVAR(&_5);
		...
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, &_5, "__construct", NULL, 94, &_10);
		zephir_check_call_status();
	}
...
PHP_METHOD(Zim_Routing_Router, matchCollection) {
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_1), _2)
	{
		...
		ZVAL_LONG(&_24$$3, 1);
		ZEPHIR_CALL_FUNCTION(&_25$$3, "array_slice", &_26, 126, &matches, &_24$$3);
		zephir_check_call_status();
