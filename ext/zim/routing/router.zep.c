...
PHP_METHOD(Zim_Routing_Router, addRoute) {
	...
	if (_0) {
		...
		ZEPHIR_CALL_FUNCTION(&name, "sha1", NULL, 110, &_3$$4);
		zephir_check_call_status();
	}
...
PHP_METHOD(Zim_Routing_Router, createRoute) {
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 111, &uri, &defaults, &requirements, methods, &options);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Zim_Routing_Router, match) {
	...
	if (_2) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_4$$4, "__construct", NULL, 88);
		zephir_check_call_status();
	...
	if (0 < zephir_fast_count_int(&_6 TSRMLS_CC)) {
		...
		ZEPHIR_CALL_FUNCTION(&_8, "array_unique", NULL, 104, &_7);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, &_5, "__construct", NULL, 113, &_8);
		zephir_check_call_status();
	} else {
		ZEPHIR_INIT_NVAR(&_5);
		...
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, &_5, "__construct", NULL, 88, &_10);
		zephir_check_call_status();
	}
...
PHP_METHOD(Zim_Routing_Router, matchCollection) {
	...
	ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_1), _3, _4, _2)
	{
		...
		ZVAL_LONG(&_30$$3, 1);
		ZEPHIR_CALL_FUNCTION(&_31$$3, "array_slice", &_32, 114, &matches, &_30$$3);
		zephir_check_call_status();
