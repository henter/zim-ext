...
ZEND_BEGIN_ARG_INFO_EX(arginfo_zim_routing_registrar_attribute, 0, 0, 2)
...
ZEPHIR_INIT_FUNCS(zim_routing_registrar_method_entry) {
	...
	PHP_ME(Zim_Routing_Registrar, attribute, arginfo_zim_routing_registrar_attribute, ZEND_ACC_PUBLIC)
