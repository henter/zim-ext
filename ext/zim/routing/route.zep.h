...
#if PHP_VERSION_ID >= 70200
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_zim_routing_route_getparameters, 0, 0, IS_ARRAY, 0)
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_zim_routing_route_getparameters, 0, 0, IS_ARRAY, NULL, 0)
#endif
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(zim_routing_route_method_entry) {
	...
	PHP_ME(Zim_Routing_Route, getParameters, arginfo_zim_routing_route_getparameters, ZEND_ACC_PUBLIC)
