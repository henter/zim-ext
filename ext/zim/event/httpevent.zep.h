...
PHP_METHOD(Zim_Event_HttpEvent, hasResponse);
...
#if PHP_VERSION_ID >= 70200
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_zim_event_httpevent_hasresponse, 0, 0, _IS_BOOL, 0)
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_zim_event_httpevent_hasresponse, 0, 0, _IS_BOOL, NULL, 0)
#endif
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(zim_event_httpevent_method_entry) {
	...
	PHP_ME(Zim_Event_HttpEvent, hasResponse, arginfo_zim_event_httpevent_hasresponse, ZEND_ACC_PUBLIC)
