...
PHP_METHOD(Zim_Zim, getInstance) {
	...
	if (Z_TYPE_P(&_0) == IS_NULL) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 135);
		zephir_check_call_status();
...
PHP_METHOD(Zim_Zim, bootstrapContainer) {
	...
	ZEPHIR_CALL_METHOD(NULL, &_2, "__construct", NULL, 137);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_3);
...
PHP_METHOD(Zim_Zim, inConsole) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "php_sapi_name", &_1, 138);
	zephir_check_call_status();
	_2 = ZEPHIR_IS_STRING_IDENTICAL(&_0, "cli");
	if (!(_2)) {
		ZEPHIR_CALL_FUNCTION(&_3, "php_sapi_name", &_1, 138);
		zephir_check_call_status();
...
PHP_METHOD(Zim_Zim, basePath) {
	...
	zephir_check_call_status();
	if (zephir_is_true(&_3)) {
		ZEPHIR_CALL_FUNCTION(&_4$$4, "getcwd", &_5, 139);
		zephir_check_call_status();
		zephir_update_property_zval(this_ptr, SL("basePath"), &_4$$4);
	} else {
		ZEPHIR_CALL_FUNCTION(&_6$$5, "getcwd", &_5, 139);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_7$$5);
		ZEPHIR_CONCAT_VS(&_7$$5, &_6$$5, "/../");
		ZEPHIR_CALL_FUNCTION(&_8$$5, "realpath", NULL, 140, &_7$$5);
		zephir_check_call_status();
		zephir_update_property_zval(this_ptr, SL("basePath"), &_8$$5);
	}
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "basepath", NULL, 141, path);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Zim_Zim, getConfigPath) {
	...
	if (!(zephir_is_true(name))) {
		...
		if ((zephir_file_exists(&appConfigDir TSRMLS_CC) == SUCCESS)) {
			...
			ZEPHIR_CALL_METHOD(&path, this_ptr, "basepath", &_2, 141, &_3$$5);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_4$$7, this_ptr, "basepath", &_2, 141, &_5$$7);
		zephir_check_call_status();
		...
		if ((zephir_file_exists(&appConfigPath TSRMLS_CC) == SUCCESS)) {
			...
			ZEPHIR_CALL_METHOD(&path, this_ptr, "basepath", &_2, 141, &_6$$9);
			zephir_check_call_status();
			if ((zephir_file_exists(&path TSRMLS_CC) == SUCCESS)) {
				RETURN_CCTOR(&path);
			}
...
PHP_METHOD(Zim_Zim, registerErrorHandling) {
	...
	if (!(zephir_is_true(&_1))) {
		...
		ZVAL_LONG(&_3$$3, 0);
		ZEPHIR_CALL_FUNCTION(NULL, "ini_set", NULL, 142, &_2$$3, &_3$$3);
		zephir_check_call_status();
