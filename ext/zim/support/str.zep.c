...
PHP_METHOD(Zim_Support_Str, after) {
	...
	if (ZEPHIR_IS_STRING_IDENTICAL(&search, "")) {
		...
		ZEPHIR_CALL_FUNCTION(&_2, "array_reverse", NULL, 111, &_1);
...
PHP_METHOD(Zim_Support_Str, camel) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_4, "lcfirst", NULL, 120, &_3);
	zephir_check_call_status();
...
PHP_METHOD(Zim_Support_Str, contains) {
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _1)
	{
		...
		if (_2$$3) {
			ZEPHIR_CALL_FUNCTION(&_3$$3, "mb_strpos", &_4, 121, &haystack, &needle);
			zephir_check_call_status();
...
PHP_METHOD(Zim_Support_Str, finish) {
	...
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "");
	ZEPHIR_CALL_FUNCTION(&_2, "preg_replace", NULL, 81, &_1, &_0, &value);
	zephir_check_call_status();
...
PHP_METHOD(Zim_Support_Str, length) {
	...
	if (!(Z_TYPE_P(&encoding) == IS_UNDEF) && Z_STRLEN_P(&encoding)) {
		ZEPHIR_RETURN_CALL_FUNCTION("mb_strlen", &_0, 122, &value, &encoding);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_RETURN_CALL_FUNCTION("mb_strlen", &_0, 122, &value);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Zim_Support_Str, limit) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "mb_strwidth", NULL, 123, &value, &_0);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_6, "mb_strimwidth", NULL, 124, &value, &_2, &_3, &_4, &_5);
	zephir_check_call_status();
...
PHP_METHOD(Zim_Support_Str, lower) {
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "UTF-8");
	ZEPHIR_RETURN_CALL_FUNCTION("mb_strtolower", NULL, 125, &value, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Zim_Support_Str, random) {
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&bytes, "random_bytes", &_0, 126, &size);
		zephir_check_call_status();
		...
		ZVAL_STRING(&_3$$3, "=");
		zephir_array_fast_append(&_2$$3, &_3$$3);
		ZEPHIR_CALL_FUNCTION(&_4$$3, "base64_encode", &_5, 103, &bytes);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_3$$3);
		ZVAL_STRING(&_3$$3, "");
...
PHP_METHOD(Zim_Support_Str, replaceLast) {
	...
	ZEPHIR_CALL_FUNCTION(&position, "strrpos", NULL, 48, &subject, &search);
	zephir_check_call_status();
	if (!ZEPHIR_IS_FALSE_IDENTICAL(&position)) {
...
PHP_METHOD(Zim_Support_Str, upper) {
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "UTF-8");
	ZEPHIR_RETURN_CALL_FUNCTION("mb_strtoupper", NULL, 127, &value, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Zim_Support_Str, title) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("mb_convert_case", NULL, 128, &value, &_0, &_1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Zim_Support_Str, snake) {
	...
	ZEPHIR_CALL_FUNCTION(&_5, "ctype_lower", NULL, 129, &value);
	zephir_check_call_status();
	if (!(zephir_is_true(&_5))) {
		...
		ZVAL_STRING(&_8$$4, "");
		ZEPHIR_CALL_FUNCTION(&tmpValue, "preg_replace", &_9, 81, &_7$$4, &_8$$4, &_6$$4);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_10$$4);
		ZEPHIR_CONCAT_SV(&_10$$4, "$1", &delimiter);
		ZEPHIR_INIT_NVAR(&_7$$4);
		ZVAL_STRING(&_7$$4, "/(.)(?=[A-Z])/u");
		ZEPHIR_CALL_FUNCTION(&_11$$4, "preg_replace", &_9, 81, &_7$$4, &_10$$4, &tmpValue);
		zephir_check_call_status();
...
PHP_METHOD(Zim_Support_Str, substr) {
	...
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "UTF-8");
	ZEPHIR_RETURN_CALL_FUNCTION("mb_substr", NULL, 130, &stringg, &_0, length, &_1);
	zephir_check_call_status();
	RETURN_MM();
