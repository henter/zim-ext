...
#if PHP_VERSION_ID >= 70200
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_zim_zim_inextension, 0, 0, _IS_BOOL, 0)
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_zim_zim_inextension, 0, 0, _IS_BOOL, NULL, 0)
#endif
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(zim_zim_method_entry) {
	...
	PHP_ME(Zim_Zim, inExtension, arginfo_zim_zim_inextension, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Zim_Zim, run, NULL, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_FE_END
};
