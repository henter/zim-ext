...
PHP_METHOD(Zim_Http_ServerBag, getHeaders) {
	...
	if (zephir_array_isset_string(&_8, SL("PHP_AUTH_USER"))) {
		...
		if (Z_TYPE_P(&authorizationHeader) != IS_NULL) {
			...
			ZEPHIR_CALL_FUNCTION(&_19$$10, "stripos", NULL, 27, &authorizationHeader, &_18$$10);
			...
			if (_22$$10) {
				...
				ZEPHIR_CALL_FUNCTION(&_23$$10, "stripos", NULL, 27, &authorizationHeader, &_18$$10);
				zephir_check_call_status();
				_22$$10 = ZEPHIR_IS_LONG_IDENTICAL(&_23$$10, 0);
			}
			ZEPHIR_INIT_NVAR(&_18$$10);
			ZVAL_STRING(&_18$$10, "bearer ");
			ZEPHIR_CALL_FUNCTION(&_24$$10, "stripos", NULL, 27, &authorizationHeader, &_18$$10);
			zephir_check_call_status();
			if (ZEPHIR_IS_LONG_IDENTICAL(&_19$$10, 0)) {
				...
				ZEPHIR_CALL_FUNCTION(&_27$$11, "base64_decode", NULL, 113, &_26$$11);
				zephir_check_call_status();
	...
	if (zephir_array_isset_string(&headers, SL("PHP_AUTH_USER"))) {
		...
		ZEPHIR_CALL_FUNCTION(&_34$$16, "base64_encode", NULL, 114, &_33$$16);
		zephir_check_call_status();
