...
PHP_METHOD(Zim_Http_Response, __construct) {
	...
	ZEPHIR_CALL_METHOD(NULL, &_0, "__construct", NULL, 25, &headers);
...
PHP_METHOD(Zim_Http_Response, create) {
	...
	ZVAL_LONG(&_0, status);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 26, content, &_0, &headers);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Zim_Http_Response, __toString) {
	...
	ZEPHIR_CALL_FUNCTION(&_4, "sprintf", NULL, 17, &_3, &_0, &_1, &_2);
	zephir_check_call_status();
...
PHP_METHOD(Zim_Http_Response, prepare) {
	...
	if (_2) {
		...
		ZEPHIR_CALL_FUNCTION(&_15$$4, "stripos", NULL, 27, &_14$$4, &_8$$4);
		zephir_check_call_status();
		...
		if (_16$$4) {
			...
			ZEPHIR_CALL_FUNCTION(&_18$$4, "stripos", NULL, 27, &_17$$4, &_8$$4);
			zephir_check_call_status();
	...
	if (_34) {
		...
		ZEPHIR_INIT_VAR(&_37);
		ZVAL_STRING(&_37, "");
		ZEPHIR_CALL_METHOD(&_36, &_35, "get", NULL, 0, &_31, &_37);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_31);
...
PHP_METHOD(Zim_Http_Response, sendHeaders) {
	...
	ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_2), _4, _5, _3)
	{
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&values), _6$$4)
		{
			...
			ZEPHIR_CALL_FUNCTION(NULL, "header", &_9, 29, &_7$$5, &__$false, &_8$$5);
			zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_14, "sprintf", NULL, 17, &_13, &_10, &_11, &_12);
	zephir_check_call_status();
	zephir_read_property(&_15, this_ptr, SL("statusCode"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_FUNCTION(NULL, "header", &_9, 29, &_14, &__$true, &_15);
	zephir_check_call_status();
	RETURN_THIS();
...
PHP_METHOD(Zim_Http_Response, send) {
	...
	if ((zephir_function_exists_ex(SL("fastcgi_finish_request") TSRMLS_CC) == SUCCESS)) {
		ZEPHIR_CALL_FUNCTION(NULL, "fastcgi_finish_request", NULL, 30);
		zephir_check_call_status();
	}
	RETURN_THIS();
...
PHP_METHOD(Zim_Http_Response, setContent) {
	...
	if (_7) {
		...
		ZEPHIR_CALL_FUNCTION(&_13$$4, "sprintf", NULL, 17, &_12$$4, &_11$$4);
		zephir_check_call_status();
...
PHP_METHOD(Zim_Http_Response, setStatusCode) {
	...
	if (zephir_is_true(&_1)) {
		...
		ZVAL_LONG(&_4$$3, code);
		ZEPHIR_CALL_FUNCTION(&_5$$3, "sprintf", NULL, 17, &_3$$3, &_4$$3);
		zephir_check_call_status();
 ...
 * @final
 */
PHP_METHOD(Zim_Http_Response, setPublic) {
	...
	zephir_read_property(&_0, this_ptr, SL("headers"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "public");
	ZEPHIR_CALL_METHOD(NULL, &_0, "addcachecontroldirective", NULL, 0, &_1);
	zephir_check_call_status();
	zephir_read_property(&_2, this_ptr, SL("headers"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "private");
	ZEPHIR_CALL_METHOD(NULL, &_2, "removecachecontroldirective", NULL, 0, &_1);
	zephir_check_call_status();
	RETURN_THIS();
 ...
 * @final
 */
PHP_METHOD(Zim_Http_Response, setPrivate) {
	...
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "public");
	ZEPHIR_CALL_METHOD(NULL, &_0, "removecachecontroldirective", NULL, 0, &_1);
	zephir_check_call_status();
	zephir_read_property(&_2, this_ptr, SL("headers"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "private");
	ZEPHIR_CALL_METHOD(NULL, &_2, "addcachecontroldirective", NULL, 0, &_1);
	zephir_check_call_status();
	RETURN_THIS();
 ...
 * @final
 */
PHP_METHOD(Zim_Http_Response, getDate) {
	...
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "Date");
	ZEPHIR_RETURN_CALL_METHOD(&_0, "getdate", NULL, 0, &_1);
	zephir_check_call_status();
	RETURN_MM();
 ...
 * @final
 */
PHP_METHOD(Zim_Http_Response, setDate) {

	zend_class_entry *_2$$3;
	zend_bool _0;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *date, date_sub, d, _3, _4, _5, _6, _7, _1$$3;
	zval *this_ptr = getThis();
	...
	ZEPHIR_MM_GROW();
	zephir_fetch_params(1, 1, 0, &date);



	ZEPHIR_CPY_WRT(&d, date);
	_0 = Z_TYPE_P(&d) == IS_OBJECT;
	if (_0) {
		_0 = zephir_instance_of_ev(&d, php_date_get_date_ce() TSRMLS_CC);
	}
	if (_0) {
		_2$$3 = zephir_fetch_class_str_ex(SL("DateTimeImmutable"), ZEND_FETCH_CLASS_AUTO);
		ZEPHIR_CALL_CE_STATIC(&_1$$3, _2$$3, "createfrommutable", NULL, 0, &d);
		zephir_check_call_status();
		ZEPHIR_CPY_WRT(&d, &_1$$3);
	}
	ZEPHIR_INIT_VAR(&_4);
	object_init_ex(&_4, php_date_get_timezone_ce());
	ZEPHIR_INIT_VAR(&_5);
	ZVAL_STRING(&_5, "UTC");
	ZEPHIR_CALL_METHOD(NULL, &_4, "__construct", NULL, 0, &_5);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_3, &d, "settimezone", NULL, 0, &_4);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&d, &_3);
	zephir_read_property(&_6, this_ptr, SL("headers"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_NVAR(&_5);
	ZVAL_STRING(&_5, "D, d M Y H:i:s");
	ZEPHIR_CALL_METHOD(&_3, &d, "format", NULL, 0, &_5);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_7);
	ZEPHIR_CONCAT_VS(&_7, &_3, " GMT");
	ZEPHIR_INIT_NVAR(&_5);
	ZVAL_STRING(&_5, "Date");
	ZEPHIR_CALL_METHOD(NULL, &_6, "set", NULL, 0, &_5, &_7);
	zephir_check_call_status();
	RETURN_THIS();
