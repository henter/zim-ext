...
#if PHP_VERSION_ID >= 70200
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_zim_http_controller_getaction, 0, 1, IS_STRING, 1)
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_zim_http_controller_getaction, 0, 1, IS_STRING, NULL, 1)
#endif
	ZEND_ARG_INFO(0, uri)
ZEND_END_ARG_INFO()
