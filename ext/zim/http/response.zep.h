...
ZEND_BEGIN_ARG_INFO_EX(arginfo_zim_http_response_setdate, 0, 0, 1)
...
ZEPHIR_INIT_FUNCS(zim_http_response_method_entry) {
	...
	PHP_ME(Zim_Http_Response, setPublic, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(Zim_Http_Response, setPrivate, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(Zim_Http_Response, getDate, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(Zim_Http_Response, setDate, arginfo_zim_http_response_setdate, ZEND_ACC_PUBLIC)
