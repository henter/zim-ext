...
PHP_METHOD(Zim_Http_Kernel, handle) {
	...
	ZEPHIR_CALL_METHOD(NULL, &requestEvent, "__construct", NULL, 86, request);
	zephir_check_call_status();
	ZEPHIR_CALL_CE_STATIC(NULL, zim_event_event_ce, "fire", &_3, 0, &requestEvent);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&resp, &requestEvent, "getresponse", NULL, 87);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(NULL, &respEvent, "__construct", NULL, 86, request, &response);
	zephir_check_call_status();
	ZEPHIR_CALL_CE_STATIC(NULL, zim_event_event_ce, "fire", &_3, 0, &respEvent);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_4, &respEvent, "getresponse", NULL, 87);
	zephir_check_call_status();
...
PHP_METHOD(Zim_Http_Kernel, guessController) {
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *uri_param = NULL, suffix, files, file, name, _0, _1, _2, _3, *_4, _6$$4, _7$$4;
	zval uri;
	zval *this_ptr = getThis();
	...
	ZEPHIR_CALL_FUNCTION(&files, "glob", NULL, 88, &_3);
	zephir_check_call_status();
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&files), _4)
	{
		...
		ZVAL_COPY(&file, _4);
		ZEPHIR_INIT_NVAR(&_6$$4);
		zephir_basename(&_6$$4, &file TSRMLS_CC);
		ZEPHIR_INIT_NVAR(&_7$$4);
		ZVAL_STRING(&_7$$4, "");
		ZEPHIR_CALL_CE_STATIC(&name, zim_support_str_ce, "replacelast", &_5, 0, &suffix, &_7$$4, &_6$$4);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_7$$4);
		zephir_fast_strtolower(&_7$$4, &name);
		if (ZEPHIR_IS_IDENTICAL(&uri, &_7$$4)) {
			RETURN_CCTOR(&name);
		}
	} ZEND_HASH_FOREACH_END();
	ZEPHIR_INIT_NVAR(&file);
...
PHP_METHOD(Zim_Http_Kernel, getDefaultRoute) {
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *request, request_sub, segments, tmpArray3dce46c3c731ae50bf7848ed5d0e6e5d, c, a, tmpListCA, tmpArray22fcc7b55e175de76dd5545a6ed7e004, _0, _1, _2, _3, _5, _4$$3;
	zval *this_ptr = getThis();

	ZVAL_UNDEF(&request_sub);
	ZVAL_UNDEF(&segments);
	ZVAL_UNDEF(&tmpArray3dce46c3c731ae50bf7848ed5d0e6e5d);
	ZVAL_UNDEF(&c);
	ZVAL_UNDEF(&a);
	ZVAL_UNDEF(&tmpListCA);
	ZVAL_UNDEF(&tmpArray22fcc7b55e175de76dd5545a6ed7e004);
	ZVAL_UNDEF(&_0);
	ZVAL_UNDEF(&_1);
	ZVAL_UNDEF(&_2);
	ZVAL_UNDEF(&_3);
	...
	ZEPHIR_CALL_FUNCTION(&segments, "array_filter", NULL, 89, &_0);
	zephir_check_call_status();
	if (!(zephir_is_true(&segments))) {
		ZEPHIR_INIT_VAR(&tmpArray3dce46c3c731ae50bf7848ed5d0e6e5d);
		zephir_create_array(&tmpArray3dce46c3c731ae50bf7848ed5d0e6e5d, 2, 0 TSRMLS_CC);
		ZEPHIR_INIT_VAR(&_4$$3);
		ZVAL_STRING(&_4$$3, "Index");
		zephir_array_fast_append(&tmpArray3dce46c3c731ae50bf7848ed5d0e6e5d, &_4$$3);
		ZEPHIR_INIT_NVAR(&_4$$3);
		ZVAL_STRING(&_4$$3, "index");
		zephir_array_fast_append(&tmpArray3dce46c3c731ae50bf7848ed5d0e6e5d, &_4$$3);
		RETURN_CCTOR(&tmpArray3dce46c3c731ae50bf7848ed5d0e6e5d);
	}
	...
	zephir_array_fast_append(&tmpArray22fcc7b55e175de76dd5545a6ed7e004, &c);
	zephir_array_fast_append(&tmpArray22fcc7b55e175de76dd5545a6ed7e004, &a);
	RETURN_CCTOR(&tmpArray22fcc7b55e175de76dd5545a6ed7e004);
...
PHP_METHOD(Zim_Http_Kernel, dispatchToRouter) {
	...
	if (!(zephir_is_true(&callablee))) {
		...
		if (!(zephir_is_callable(&callablee TSRMLS_CC))) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_6$$4, "__construct", NULL, 90, &_8$$4);
			zephir_check_call_status();
...
PHP_METHOD(Zim_Http_Kernel, doDispatch) {
	...
	ZEPHIR_CALL_METHOD(NULL, &e, "__construct", NULL, 86, request);
	zephir_check_call_status();
	ZEPHIR_CALL_CE_STATIC(NULL, zim_event_event_ce, "fire", &_8, 0, &e);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&resp, &e, "getresponse", NULL, 87);
	zephir_check_call_status();
	if (zephir_is_true(&resp)) {
		ZEPHIR_RETURN_CALL_METHOD(&resp, "prepare", NULL, 0, request);
		zephir_check_call_status();
...
PHP_METHOD(Zim_Http_Kernel, toResponse) {
	...
	zend_bool _0$$4, _1$$4;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *resp, resp_sub, response, _2$$6, _3$$6, _4$$6;
	zval *this_ptr = getThis();
	...
	if (zephir_instance_of_ev(resp, zim_http_response_ce TSRMLS_CC)) {
		ZEPHIR_CPY_WRT(&response, resp);
	} else {
		_0$$4 = Z_TYPE_P(resp) == IS_ARRAY;
		if (!(_0$$4)) {
			_0$$4 = zephir_is_scalar(resp);
		}
		_1$$4 = _0$$4;
		if (!(_1$$4)) {
			_1$$4 = Z_TYPE_P(resp) == IS_NULL;
		}
		if (_1$$4) {
			...
			object_init_ex(&_2$$6, zim_http_exception_responseexception_ce);
			ZVAL_LONG(&_3$$6, 500);
			ZEPHIR_INIT_VAR(&_4$$6);
			ZVAL_STRING(&_4$$6, "invalid response");
			ZEPHIR_CALL_METHOD(NULL, &_2$$6, "__construct", NULL, 91, &_3$$6, &_4$$6);
			zephir_check_call_status();
			zephir_throw_exception_debug(&_2$$6, "zim/http/kernel.zep", 251 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
	}
...
PHP_METHOD(Zim_Http_Kernel, terminate) {
	...
	ZEPHIR_CALL_METHOD(NULL, &_1, "__construct", NULL, 86, request, response);
	zephir_check_call_status();
