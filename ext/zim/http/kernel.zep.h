...
#endif
	ZEND_ARG_OBJ_INFO(0, request, Zim\\Http\\Request, 0)
	ZEND_ARG_INFO(0, callablee)
	ZEND_ARG_ARRAY_INFO(0, params, 0)
ZEND_END_ARG_INFO()

#if PHP_VERSION_ID >= 70200
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_zim_http_kernel_toresponse, 0, 1, Zim\\Http\\Response, 0)
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_zim_http_kernel_toresponse, 0, 1, IS_OBJECT, "Zim\\Http\\Response", 0)
#endif
