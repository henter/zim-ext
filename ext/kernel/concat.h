...
#define ZEPHIR_CONCAT_SSVSSS(result, op1, op2, op3, op4, op5, op6) \
	 zephir_concat_ssvsss(result, op1, sizeof(op1)-1, op2, sizeof(op2)-1, op3, op4, sizeof(op4)-1, op5, sizeof(op5)-1, op6, sizeof(op6)-1, 0);
#define ZEPHIR_SCONCAT_SSVSSS(result, op1, op2, op3, op4, op5, op6) \
	 zephir_concat_ssvsss(result, op1, sizeof(op1)-1, op2, sizeof(op2)-1, op3, op4, sizeof(op4)-1, op5, sizeof(op5)-1, op6, sizeof(op6)-1, 1);
...
#define ZEPHIR_CONCAT_SVSSSVS(result, op1, op2, op3, op4, op5, op6, op7) \
	 zephir_concat_svsssvs(result, op1, sizeof(op1)-1, op2, op3, sizeof(op3)-1, op4, sizeof(op4)-1, op5, sizeof(op5)-1, op6, op7, sizeof(op7)-1, 0);
#define ZEPHIR_SCONCAT_SVSSSVS(result, op1, op2, op3, op4, op5, op6, op7) \
	 zephir_concat_svsssvs(result, op1, sizeof(op1)-1, op2, op3, sizeof(op3)-1, op4, sizeof(op4)-1, op5, sizeof(op5)-1, op6, op7, sizeof(op7)-1, 1);
...
void zephir_concat_ssvsss(zval *result, const char *op1, zend_uint op1_len, const char *op2, zend_uint op2_len, zval *op3, const char *op4, zend_uint op4_len, const char *op5, zend_uint op5_len, const char *op6, zend_uint op6_len, int self_var);
...
void zephir_concat_svsssvs(zval *result, const char *op1, zend_uint op1_len, zval *op2, const char *op3, zend_uint op3_len, const char *op4, zend_uint op4_len, const char *op5, zend_uint op5_len, zval *op6, const char *op7, zend_uint op7_len, int self_var);
