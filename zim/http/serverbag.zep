    ...
    public function getHeaders() -> array
    {
        ...
        if isset this->parameters["PHP_AUTH_USER"] {
            ...
            if isset this->parameters["HTTP_AUTHORIZATION"] {
                ...
                let authorizationHeader = this->parameters["REDIRECT_HTTP_AUTHORIZATION"];
            }
            if authorizationHeader !== null {
                if 0 === stripos(authorizationHeader, "basic ") {
                    ...
                    if 2 == count(exploded) {
                        ...
                        let headers["PHP_AUTH_PW"] = tmpListHeadersPHP_AUTH_USERHeadersPHP_AUTH_PW[1];
                    }
                } elseif empty(this->parameters["PHP_AUTH_DIGEST"]) && 0 === stripos(authorizationHeader, "digest ") {
                    // In some circumstances PHP_AUTH_DIGEST needs to be set
                    let headers["PHP_AUTH_DIGEST"] = authorizationHeader;
                    let this->parameters["PHP_AUTH_DIGEST"] = authorizationHeader;
