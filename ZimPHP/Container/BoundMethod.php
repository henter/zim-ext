...
class BoundMethod
{
    ...
    protected static function getMethodDependencies(Container $container, $callback, array $parameters = [])
    {
        ...
        foreach (static::getCallReflector($callback)->getParameters() as $parameter) {
            list($parameters, $dependencies) = static::addDependencyForCallParameter($container, $parameter, $parameters, $dependencies);
        }
     ...
     * @return mixed
     */
    protected static function addDependencyForCallParameter(Container $container, $parameter, array $parameters, $dependencies)
    {
